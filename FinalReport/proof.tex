...
Recall that each node's portion of the snapshot occurs when that node
...
in the 10-20 millisecond range, yielding 20-40 millisecond freeze %% TODO this is inaccurate but idk what we want to do about it
...
If we want to store the uncertainty information of the nodes in
