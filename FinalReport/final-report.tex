...
\usepackage{xspace}
\newcommand{\alg}{\textsc{CASTS}\xspace}
...
\title{Achieving Distributed Point-in-Time Consistency for Geo-Replication}

%% Who are the authors of the report (your team members)?  (Separate
%% names with \and.)
\author{Nick Carter \and Matt Cook \and Philip Davis \and Michael Saffron~(Project Manager)}
...
\begin{abstract}
  ...
  performance. We use data from a real Ceph cluster to build models of packet 
  latency and clock drift. We use those models to run simulations of a networked system of 
  computers. These simulations confirm that the Network Time Protocol (NTP) 
...
\begin{center}
We would like to thank our advisor, Professor Beth Trushkowsky.


We would also like to thank our liaisons at Red Hat---Ian Colle, Greg Farnum '09, Sam Just '10, and Sage Weil '00.
\end{center}
