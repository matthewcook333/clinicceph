...
\begin{figure}[h]
  \centering
  \caption{Histogram of network latency across 235 nodes in a Ceph test cluster. The mean latency was Z ms and the standard deviation was W ms.} %% TODO please fill out your section
